    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    dbContext.tbl_Customers.Add(new Customer
                    {
        ...
        public async Task<string> NewUser(string username, string password)
        {
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            if (username != null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.ConfirmEmailAsync(userInfos, code);
